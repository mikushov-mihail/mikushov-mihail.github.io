...
/// @type Color
//$orbit-bullet-background-active: $decorative !default;

/// Default diameter for Orbit's bullets.
/// @type Number
$orbit-bullet-diameter: 0.8rem !default;

/// Default hover diameter for Orbit's bullets.
/// @type Number
$orbit-bullet-diameter-hover: 0.4rem !default;
...
@mixin orbit-bullets {
  ...
  button {
    ...
    border-radius: 50%;
    border: 1px solid $orbit-bullet-background;
    transition: all 0.2s ease-in-out;

    &:hover {
      border: $orbit-bullet-diameter-hover solid #d89393;
    }
