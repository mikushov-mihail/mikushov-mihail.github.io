 ...
 */
window.onload=function(){ShowMoreElements("show","show_more");Hamburger()};function ShowMoreElements(a,b){var c=document.getElementById(a),d=document.getElementById(b);c.onclick=function(){d.classList.add("js_show_more");c.classList.add("none_display")}}
function Hamburger(){function a(a){a.addEventListener("click",function(a){a.preventDefault();!0===this.classList.contains("active")?this.classList.remove("active"):this.classList.add("active")})}for(var b=document.querySelectorAll(".cmn-toggle-switch"),c=b.length-1;0<=c;c--)a(b[c])}jQuery(document).ready(function(){HamburgerMenu();RollUp();AppearanceText();$(document).foundation();OrbitContainer()});var clientBrowserWidth=document.documentElement.clientWidth;function HamburgerMenu(){var a=$(".hamburger"),b=$(".drop_down_menu");a.click(function(){b.slideToggle().addClass("js_menu_overflow")});window.onresize=function(){1002<=clientBrowserWidth&&(b.attr("style","").removeClass("js_menu_overflow"),a.removeClass("active"))}}
function OrbitContainer(){var a=$(".orbit-container");1024<=clientBrowserWidth&&a.height(700);window.onresize=function(){1024<=clientBrowserWidth?a.height(800):a.height(0)}}function RollUp(){$(window).scroll(function(){var a=$("body").scrollTop(),b=$("header").outerHeight();console.log("bodyScroll: "+a);var c=$(".go_up");a>b?c.addClass("js_go_up_visible"):c.removeClass("js_go_up_visible")});$("#roll_up").click(function(){$("html, body").animate({scrollTop:0},500);return!1})}
function AppearanceText(){var a=0,b=$(".appearance_text"),c=b.length;$(".appearance_text_hero").addClass("visible_text_hero");$(window).scroll(function(){if(a<c){var d=$("body").scrollTop(),e=b.eq(a).offset().top;a<=c&&d>e-670&&(b.eq(a).addClass("visible_text"),a++)}})};
