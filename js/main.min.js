...
function Hamburger(){function a(a){a.addEventListener("click",function(a){a.preventDefault();!0===this.classList.contains("active")?this.classList.remove("active"):this.classList.add("active")})}for(var b=document.querySelectorAll(".cmn-toggle-switch"),c=b.length-1;0<=c;c--)a(b[c])}jQuery(document).ready(function(){HamburgerMenu();RollUp();AppearanceText();$(document).foundation();OrbitContainer()});var clientBrowserWidth=document.documentElement.clientWidth;
function HamburgerMenu(){var a=$(".hamburger"),b=$(".drop_down_menu");a.click(function(){b.slideToggle().addClass("js_menu_overflow")});window.onresize=function(){1002<=clientBrowserWidth&&(b.attr("style","").removeClass("js_menu_overflow"),a.removeClass("active"))}}function OrbitContainer(){var a=$(".orbit-container");1024<=clientBrowserWidth&&a.height(700);window.onresize=function(){1024<=clientBrowserWidth&&a.height(800)}}
function RollUp(){$(window).scroll(function(){var a=$("body").scrollTop(),b=$("header").outerHeight();console.log("bodyScroll: "+a);var c=$(".go_up");a>b?c.addClass("js_go_up_visible"):c.removeClass("js_go_up_visible")});$("#roll_up").click(function(){$("html, body").animate({scrollTop:0},500);return!1})}
